...
class Report:
    ...
    def build_report_details(self):
        ...
        section_text = [f'## QuickEEG Report Details',
    ...
    def build_erp_plot(self):

        """
        Builds the ERP plot for the EEG report
        ...
        #Add ERP plot to PDF
        electrode_name = self.eeg.erp_plot_filename.split('_e')[-2].split('_')[0]
        section_text = [f'## ERP Plot at electrode {electrode_name}',
                        f'![ERP Plot]({self.eeg.erp_plot_filename})']
